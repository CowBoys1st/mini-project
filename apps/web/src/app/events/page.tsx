...
import { IEvent, IEventList, IEventWithImage } from '@/type/event';
            ...
            >
              <div className="w-full h-48 bg-gray-200 rounded-lg flex items-center justify-center mb-4">
                {event.image.length > 0 ? (
                  <Image
                    src={event.image[0].url} // URL gambar dari data event
                    alt={`Image of ${event.name}`}
                    width={500} // Lebar gambar (sesuaikan)
                    height={300} // Tinggi gambar (sesuaikan)
